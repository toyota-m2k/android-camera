...
fun ChapterPlayerModel(context:Context, coroutineScope: CoroutineScope):ChapterPlayerModel {
    val playerModel = BasicPlayerModel(context, coroutineScope)
...
fun PlaylistChapterPlayerModel(context: Context, coroutineScope: CoroutineScope, playlist:IMediaFeed, autoPlay: Boolean, continuousPlay: Boolean):PlaylistChapterPlayerModel {
    val playerModel = BasicPlayerModel(context, coroutineScope)
    val playlistHandler = PlaylistHandlerImpl(playerModel, playlist, autoPlay, continuousPlay)
    val chapterHandler = ChapterHandlerImpl(playerModel)
